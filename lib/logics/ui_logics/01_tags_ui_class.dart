...
class ChatTagInfo {
  ...
  ChatTagInfo(this.label, this.background_color, this.border_color, this.show_tag);

}

// FUNCTION TO GET ALL THE INFO FROM THE DECK TAGS
ChatTagInfo get_chat_tag_info(BuildContext context, List<String> deck_tags_list) {

  // CHECKING IF THE TAG HAS TO BE SHOWN
  if (deck_tags_list.contains("chat")) {

    return ChatTagInfo(AppLocalizations.of(context)!.deck_chat_tag_label, Color(
        0xffa25877), Color(
        0xffa25877), true);
...
class VideoCallTagInfo {
  ...
  VideoCallTagInfo(this.label, this.background_color, this.border_color, this.show_tag);

}

// FUNCTION TO GET ALL THE INFO FROM THE DECK TAGS
VideoCallTagInfo get_video_call_tag_info(BuildContext context, List<String> deck_tags_list) {

  // CHECKING IF THE TAG HAS TO BE SHOWN
  if (deck_tags_list.contains("video_call")) {

    return VideoCallTagInfo(AppLocalizations.of(context)!.deck_video_chat_tag_label, Color(
        0xff984444), Color(
        0xff984444), true);
