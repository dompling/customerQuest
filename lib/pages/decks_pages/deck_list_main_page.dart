            ...
            slivers: [
              ...
              SliverList(
                ...
                delegate: SliverChildBuilderDelegate(
                      ...
                      (context, index) {
                    //String deck_path = loaded_decks_list[index].deck_file_path;
                    String deck_name = loaded_decks_list[index].summary.name;
                    int deck_quest_number = loaded_decks_list[index].summary.total_quests;
                    int deck_difficulty = loaded_decks_list[index].summary.average_difficulty;
                    int deck_average_duration = loaded_decks_list[index].summary.average_duration;
                    List<String> deck_tools = loaded_decks_list[index].summary.required_tools;
                  ...
                  childCount: loaded_decks_list.length,
